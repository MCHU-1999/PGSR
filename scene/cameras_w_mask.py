...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy,
        ...
        self.original_image, self.image_gray, self.mask, self.fg_mask = None, None, None, None
        self.preload_img = preload_img
        self.ncc_scale = ncc_scale
        if self.preload_img:
            gt_image, gray_image, fg_mask = process_image(self.image_path, self.resolution, ncc_scale, self.fg_mask_path)
            ...
            self.fg_mask = fg_mask.to(self.data_device)
